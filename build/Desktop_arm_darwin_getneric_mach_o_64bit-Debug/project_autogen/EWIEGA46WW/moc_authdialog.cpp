...
struct qt_meta_stringdata_CLASSAuthDialogENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSAuthDialogENDCLASS = QtMocHelpers::stringData(
    "AuthDialog",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSAuthDialogENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject AuthDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSAuthDialogENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSAuthDialogENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAuthDialogENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *AuthDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSAuthDialogENDCLASS.stringdata0))
